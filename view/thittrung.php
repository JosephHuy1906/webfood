<link rel="stylesheet" href="../css/thittrung.css">
<?php
...
<div class="main">
    <aside>
        <div class="asidemenutop">
            <ul>
                <li><a href="thittrung.php"><b>THỊT TRỨNG</b></a></li>
                <li><a href="#">THỊT TƯƠI</a></li>
                <li><a href="#">THỊT ĐÓNG HỘP</a></li>
                <li><a href="#">TRỨNG</a></li>
                <li><a href="#">THỊT ĐÔNG LẠNH</a></li>
            </ul>
        </div>
        <div class="asidemenubottom">
            <ul>
                ...
                <li><a href="thittrung.php" class="khung1">THỊT & TRỨNG</a></li>
