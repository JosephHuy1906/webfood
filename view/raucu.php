<link rel="stylesheet" href="../css/raucu.css">
<?php
...
<div class="main">
    <aside>
        <div class="asidemenutop">
            <ul>
                <li><a href="raucu.php"><b>RAU CỦ</b></a></li>
                <li><a href="#">RAU ĂN LÁ</a></li>
                <li><a href="#">RAU ĂN QUẢ</a></li>
                <li><a href="#">RAU ĂN CỦ</a></li>
                <li><a href="#">RAU CỦ ĐÓNG HỘP</a></li>
                <li><a href="#">RAU CỦ SẤY KHÔ</a></li>
            </ul>
        </div>
        <div class="asidemenubottom">
            <ul>
                <li><a href="traicay.php">TRÁI CÂY</a></li>
                <li><a href="raucu.php" class="khung1">RAU CỦ</a></li>
