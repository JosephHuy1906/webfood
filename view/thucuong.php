<link rel="stylesheet" href="../css/thucuong.css">
<?php
...
<div class="main">
    <aside>
        <div class="asidemenutop">
            <ul>
                <li><a href="thucuong.php"><b>THỨC UỐNG</b></a></li>
                <li><a href="#">SỮA</a></li>
                <li><a href="#">CÁC THỨC UỐNG KHÁC</a></li>
                <li><a href="#">NƯỚC TRÁI CÂY</a></li>
                <li><a href="#">NƯỚC KHOÁNG</a></li>
                <li><a href="#">Guanabana Smoothies</a></li>
            </ul>
        </div>
        <div class="asidemenubottom">
            <ul>
                ...
                <li><a href="thucuong.php" class="khung1">THỨC UỐNG</a></li>
