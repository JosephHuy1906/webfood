            ...
            <main>
                ...
                ';
                    ...
                    <tr>
                        ...
                        <td class="ad"><a href="ad/suadanhmuc.php?page_layout=sua&id=' . $row['id'] . '"> <i class="fa-solid fa-pen"></i> </a></td>
                        <td class="ad"><a onclick="return Del()" href="ad/xoadanhmuc.php?page_layout=xoa&id=' . $row['id'] . '"> <i class="fa-solid fa-trash"></i> </a></td>
                    </tr>
                    ';
                        }
                    }
