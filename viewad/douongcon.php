        ...
        <div class="main">
            <main>
                ...
                if ($conn == false) {
                    ...
                    $query = "SELECT*FROM douongcon ORDER BY id ASC limit $start_from, $limit";
                ...
                ';
                    echo '
                        ...
                        <td class="them"> <a href="../ad/themdouongcon.php"><i class="fa-solid fa-circle-plus"></i> Thêm</a> </td>
                        </tr>
                    ';
                    echo '
                    <tr>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '
                                <tr>
                                    ...
                                    <td class="ad"><a href="../ad/suadouongcon.php?page_layout=sua&id=' . $row['id'] . '"> <i class="fa-solid fa-pen"></i> </a></td>
                                    <td class="ad"><a onclick="return Del()" href="../ad/xoadouongcon.php?page_layout=xoa&id=' . $row['id'] . '"> <i class="fa-solid fa-trash"></i> </a></td>
                                </tr>
                                ';
                        }
                    }
        ...
        <div class="chuyentrang" style="text-align: center;"> 
                     <?php
                        ...
                        for($i=1; $i<=$paper; $i++){
                            ...
                            <a href=douongcon.php?page=".$i.">$i<a/>
                            </div>";
                        }
                        echo "</div>";
                     ?>
