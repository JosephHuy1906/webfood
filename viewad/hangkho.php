        ...
        <div class="main">
            <main>
                ...
                if ($conn == false) {
                    ...
                    $query = "SELECT*FROM hangkho ORDER BY id ASC limit $start_from, $limit";
                ...
                ';
                        ...
                        <td class="them"> <a href="../ad/themhangkho.php"><i class="fa-solid fa-circle-plus"></i> Thêm</a> </td>
                        </tr>
                    ';
                        echo '
                    <tr>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '
                                <tr>
                                    ...
                                    <td class="ad"><a href="../ad/suahangkho.php?page_layout=sua&id=' . $row['id'] . '"> <i class="fa-solid fa-pen"></i> </a></td>
                                    <td class="ad"><a onclick="return Del()" href="../ad/xoahangkho.php?page_layout=xoa&id=' . $row['id'] . '"> <i class="fa-solid fa-trash"></i> </a></td>
                                </tr>
                                ';
                        }
                    }
